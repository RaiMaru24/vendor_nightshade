#
# NightShade Audio Files
#

ALARM_PATH := vendor/nightshade/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/nightshade/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/nightshade/prebuilt/common/media/audio/ringtones
