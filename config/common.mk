...
PRODUCT_COPY_FILES += \
    vendor/nightshade/prebuilt/common/etc/sysconfig/pixel_2016_exclusive.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/pixel_2016_exclusive.xml \
...
# Privapp permissions
PRODUCT_COPY_FILES += \
    vendor/nightshade/config/permissions/privapp-permissions-custom.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-custom.xml
...
# Enable SIP+VoIP on all targets
PRODUCT_COPY_FILES += \
    vendor/nightshade/prebuilt/google/etc/permissions/privapp-permissions-googleapps-turbo.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/privapp-permissions-googleapps-turbo.xml
...
$(call enforce-product-packages-exist-internal,$(wildcard device/*/$(NIGHTSHADE_BUILD)/$(TARGET_PRODUCT).mk),product_manifest.xml)
