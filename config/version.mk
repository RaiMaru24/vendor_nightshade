...
NIGHTSHADE_BUILD_DATE_UTC := $(shell date -d '$(NIGHTSHADE_DATE_YEAR)-$(NIGHTSHADE_DATE_MONTH)-$(NIGHTSHADE_DATE_DAY) $(NIGHTSHADE_DATE_HOUR):$(NIGHTSHADE_DATE_MINUTE) UTC' +%s)
